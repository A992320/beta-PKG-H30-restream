...
// طبقة Netflix Home مستقلة: المظهر فقط، بلا تغيير منطق الصفحة أو المشغّل.
require_once __DIR__ . '/site/includes/netflix_home.php';
// اختصارات الصفحة الرئيسية أصبحت داخل الشريط العلوي؛ لا توجد قائمة جانبية منفصلة.
