<section id="categories" class="sec">
  ...
  <div class="tw">
    ...
    <td><div class="acts"><button class="ib ed" onclick='editCat(<?php echo json_encode(['id'=>$cat['id'],'name'=>$cat['name'],'icon'=>$cat['icon'],'parent_id'=>$cat['parent_id']??null,'description'=>$cat['description']??'']); ?>)'><i class="fas fa-pen"></i></button><button class="ib dl" onclick="deleteCategory(<?php echo (int)$cat['id']; ?>, this)"><i class="fas fa-trash"></i></button></div></td></tr>
    <?php endforeach; ?>
    </tbody></table>
