...
<form method="POST"><?= csrfField() ?><div class="mbody"><div class="fg"><label class="fl">القسم</label><select name="category_id" class="fs" required><option value="">— اختر القسم —</option><?php foreach($categories as $cat): ?><option value="<?php echo $cat['id']; ?>"><?php echo htmlspecialchars($cat['name']); ?></option><?php endforeach; ?></select></div>
...
<div class="fg" style="padding:12px;border:1px solid rgba(76,201,240,.35);border-radius:10px;background:rgba(76,201,240,.06)"><label class="fl" style="color:#4CC9F0"><i class="fas fa-volume-up" style="margin-left:5px"></i>رابط بث الصوت <span style="font-weight:400">— اختياري</span></label><small style="display:block;margin:-2px 0 8px;color:var(--t3)">ضع الرابط فقط عندما يمنحك مزوّد القناة مسار صوت منفصلاً.</small><input type="text" name="audio_url" class="fi" placeholder="https://... رابط بث الصوت"></div>
<div class="fg"><label class="fl"><i class="fas fa-clock" style="margin-left:5px"></i>مزامنة الصوت بالثواني <span style="color:var(--t3);font-weight:400">— موجب يؤخره، سالب يقدمه</span></label><input type="number" name="audio_delay" class="fi" min="-30" max="30" step="0.05" value="0" style="direction:ltr" placeholder="0.00"></div>
...
<form method="POST"><?= csrfField() ?><div class="mbody"><input type="hidden" name="channel_id" id="eChId">
...
<div class="fg" style="padding:12px;border:1px solid rgba(76,201,240,.35);border-radius:10px;background:rgba(76,201,240,.06)"><label class="fl" style="color:#4CC9F0"><i class="fas fa-volume-up" style="margin-left:5px"></i>رابط بث الصوت <span style="font-weight:400">— اختياري</span></label><small style="display:block;margin:-2px 0 8px;color:var(--t3)">ضعه فقط عند وجود رابط صوت مستقل من مزوّد القناة.</small><input type="text" name="audio_url" id="eChAudioUrl" class="fi" placeholder="https://... رابط بث الصوت"></div>
<div class="fg"><label class="fl"><i class="fas fa-clock" style="margin-left:5px"></i>مزامنة الصوت بالثواني <span style="color:var(--t3);font-weight:400">— موجب يؤخره، سالب يقدمه</span></label><input type="number" name="audio_delay" id="eChAudioDelay" class="fi" min="-30" max="30" step="0.05" value="0" style="direction:ltr"></div>
