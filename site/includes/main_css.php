...
/* توافق لمس Android وiPhone: تمرير أفقي ثابت وارتفاع لا يتأثر بشريط المتصفح. */
.shs-mobile{-webkit-tap-highlight-color:transparent;--shs-mobile-vh:1vh}
@media(max-width:760px){
  .cat-navbar,.slider-cards-wrapper,#shsNetflixTopTabs{
    -webkit-overflow-scrolling:touch;
    overscroll-behavior-x:contain;
    scroll-behavior:smooth;
  }
  .slider-cards-wrapper{scroll-snap-type:x proximity}
  .slider-cards-wrapper>.ch-card,.slider-cards-wrapper>.sr-card{scroll-snap-align:start;scroll-snap-stop:normal}
  .shs-ios .navbar,.shs-ios .cat-navbar{-webkit-backface-visibility:hidden;backface-visibility:hidden}
  .shs-ios #playerOverlay.active{height:calc(var(--shs-mobile-vh,1vh) * 100)!important}
}

/* بطاقة SVG أنيقة للقنوات التي لا يوفّر مصدرها شعاراً */
.shs-channel-fallback{position:absolute;inset:0;z-index:1;display:grid;place-items:center;overflow:hidden;background:radial-gradient(circle at 50% 35%,rgba(33,150,243,.22),transparent 48%),linear-gradient(145deg,#171b26,#090b10)}.shs-channel-fallback::before{content:'';position:absolute;width:76%;aspect-ratio:1;border-radius:50%;background:rgba(56,189,248,.13);filter:blur(15px);animation:shsChannelPulse 2.8s ease-in-out infinite}.shs-channel-fallback-svg{width:72%;height:auto;position:relative;z-index:1;filter:drop-shadow(0 12px 14px rgba(0,0,0,.5));animation:shsChannelFloat 3s ease-in-out infinite}.shs-tv-shell{fill:#1a2231;stroke:rgba(125,211,252,.8);stroke-width:2}.shs-tv-screen{fill:#071c2a;stroke:rgba(56,189,248,.55);stroke-width:1.5}.shs-tv-wave{stroke:#7dd3fc;stroke-width:3.5;stroke-linecap:round;animation:shsChannelWave 1.8s ease-in-out infinite}.shs-tv-wave-b{animation-delay:-.9s;stroke:#38bdf8}.shs-tv-led{fill:#22c55e;filter:drop-shadow(0 0 5px #22c55e);animation:shsChannelLed 1.5s ease-in-out infinite}.shs-tv-base{stroke:#94a3b8;stroke-width:2.4;stroke-linecap:round}.shs-channel-fallback-text{position:absolute;z-index:2;bottom:12%;font-size:9px;font-weight:900;letter-spacing:.16em;color:#dbeafe;background:rgba(15,23,42,.78);border:1px solid rgba(125,211,252,.35);padding:3px 6px;border-radius:99px}.ch-icon .shs-channel-fallback{position:relative;width:100%;height:100%;min-width:80px;min-height:80px}.ch-icon .shs-channel-fallback-text{display:none}@keyframes shsChannelFloat{0%,100%{transform:translateY(0)}50%{transform:translateY(-5px)}}@keyframes shsChannelPulse{0%,100%{transform:scale(.88);opacity:.45}50%{transform:scale(1.08);opacity:.9}}@keyframes shsChannelWave{0%,100%{transform:translateX(-2px);opacity:.45}50%{transform:translateX(2px);opacity:1}}@keyframes shsChannelLed{0%,100%{opacity:.38}50%{opacity:1}}@media(prefers-reduced-motion:reduce){.shs-channel-fallback::before,.shs-channel-fallback-svg,.shs-tv-wave,.shs-tv-led{animation:none!important}}
