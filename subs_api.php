...
/* نبضة آمنة لا تغيّر أي بيانات. تكتب وقت النشاط كي لا تحذف PHP جلسة
   المدير بينما تبقى اللوحة مفتوحة، وتعيد رمز الحماية إن تبدل. */
if ($act === 'session_ping') {
    $_SESSION['admin_last_seen'] = time();
    sOk(['csrf_token' => csrfToken(), 'server_time' => time()]);
}
